...
public static class EditorDebug
{
    ...
    static void IMGUI()
    {
        EditorWindow.GetWindow(GetType("UnityEditor.GUIViewDebuggerWindow"));
    }

    [MenuItem("Window/Undo Debugger")]
    static void Undo()
    {
        EditorWindow.GetWindow(GetType("UnityEditor.UndoWindow"));
    }

    static Type GetType(string name)
    {
        return typeof(EditorApplication).Assembly.GetType(name);
    }
